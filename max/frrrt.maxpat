	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "cycle~ 440",
					"patching_rect" : [ 148.0, 303.0, 64.0, 20.0 ],
					"id" : "obj-20",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "0., 1. 1500 0.5 0. 2500 0.5",
					"patching_rect" : [ 503.0, 264.0, 151.0, 18.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "*~ 0.5",
					"patching_rect" : [ 331.0, 319.0, 42.0, 20.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "gain~",
					"patching_rect" : [ 266.0, 417.0, 36.0, 100.0 ],
					"id" : "obj-3",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "signal", "int" ]
