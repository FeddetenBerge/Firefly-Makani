 ...
 */
	public class TweenPlugin {
		...
		private static function onTweenEvent(type:String, tween:TweenLite):Boolean {
			...
			if (type == "onInit") {
				//sorts the PropTween linked list in order of priority because some plugins need to render earlier/later than others, like MotionBlurPlugin applies its controls after all x/y/alpha tweens have rendered on each frame.
				var tweens:Array = [];
				while (pt) {
