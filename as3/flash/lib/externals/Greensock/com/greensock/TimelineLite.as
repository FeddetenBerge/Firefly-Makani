 ...
 **/
	public class TimelineLite extends SimpleTimeline {
		 ...
		 * advanced timing controls and builds complex sequences with relatively little code.<br /><br />
		 *  
		 ...
		 * TimelineLite because it accommodates advanced timing controls and builds complex sequences with relatively little code.<br /><br />
		 *  
		 * @param tweens an Array containing any or all of the following: TweenLite, TweenMax, TimelineLite, and/or TimelineMax instances  
